...
This app attempts to objectify eyewitness identification by 
...
## Example
*Building a suspect lineup finds identifications with similar features from which the witness must choose the suspect*
...
## Improvements
- Build database with real photos
